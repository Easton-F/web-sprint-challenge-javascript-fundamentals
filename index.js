...
// because the entire thing is encased in the function myFunction so the internal variable may be outside the nestedFunction but they both reside in the myFunction.
...
const zooAnimals = [
  ...
  */
  ...
  console.log('T2 R1:', animalNames(zooAnimals));
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowerCaseList = array.map(obj => obj.animal_name.toLowerCase());
        return lowerCaseList;
  }
  
  console.log('T2 R2:', lowerCaseNames(zooAnimals));
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const lowPop = array.filter(obj => obj.population < 5);
    return lowPop;
  }

  console.log('T2 R3:', lowPopulationAnimals(zooAnimals));
  ...
  */
  ...
  function USApop(array){
    const totalPop = array.reduce((acc, obj) =>{
      return acc + obj.population
    },0);
    return totalPop;
  }

  console.log('T2 R4:', USApop(zooAnimals));
...
function greeting(firstName, lastName){
  ...
  console.log('CB greeting:', greeting('Easton', 'Fritsch'));
...
// ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️ ⬇️
console.log('Cube Test 1:', cuboid.volume()); // 100
console.log('Cube Test 2:', cuboid.surfaceArea()); // 130
